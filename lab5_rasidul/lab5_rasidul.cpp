...
// erase(x,y) --> x = index where characters will be removed, y = amount of characters to be removed from index x // Erase the word 'an' from 'Patrick Pan'
//Erase the word 'an' from 'patric pan'
